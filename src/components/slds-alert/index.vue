<template>
	<div v-if="open" class="slds-notify slds-notify_alert slds-theme_alert-texture slds-theme_info" v-bind:class="{'slds-theme_info': isInfo,'slds-theme_error': isError, 'slds-theme_warning': isWarning }" role="alert">
