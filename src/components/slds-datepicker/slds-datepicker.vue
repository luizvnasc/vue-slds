<template>
	<div class="slds-form-element__control slds-input-has-icon slds-input-has-icon_right" :class="{'slds-dropdown-trigger_click slds-is-open': isOpen}">
		<input type="text" id="date-input-id" placeholder=" " class="slds-input" v-model="dateString" @blur="updateValue()" />
